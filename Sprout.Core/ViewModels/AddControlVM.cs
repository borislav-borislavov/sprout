        ...
        private void AddControl()
        {
            ...
            switch (controlType)
            {
                ...
                case SproutControlType.TextBox:
                    NewControl = new SproutTextBoxConfig()
                    {
                        Name = ControlName
                    };
                    break;
                case SproutControlType.CheckBox:
                    ...
                    break;
                case SproutControlType.DatePicker:
                    NewControl = new SproutDatePickerConfig()
                    {
                        Name = ControlName
                    };
                    break;
                case SproutControlType.Border:
                    NewControl = new SproutBorderConfig()
                    {
                        Name = ControlName
                    };
                    break;
                case SproutControlType.List:
                    NewControl = new SproutListConfig()
                    {
                        Name = ControlName
                    };
                    break;
                case SproutControlType.Label:
                    NewControl = new SproutLabelConfig()
                    {
                        Name = ControlName
                    };
                    break;
                case SproutControlType.TabControl:
                    NewControl = new SproutTabControlConfig()
                    {
                        Name = ControlName
                    };
                    break;
