...
namespace Sprout.Core.Views.Controls
{
    ...
    /// </summary>
    public partial class SproutDatePicker : UserControl, ISproutControl<SproutDatePickerConfig, SproutDatePickerUIState>
    {
        public SproutDatePickerConfig Config { get; set; }
        public SproutControlType ControlType => SproutControlType.DatePicker;
        public SproutDatePickerUIState VM { get; internal set; }
